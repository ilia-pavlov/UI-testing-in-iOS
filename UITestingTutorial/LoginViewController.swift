...
class LoginViewController: UIViewController {
    ...
    // probably since app's structure was made in constractor, easy way to add
    // accessibilityIdentifier use same constractor in Main file.
    private func setupAccessibility() {
        loadingActivity.accessibilityIdentifier = AccessibilityIndetifier.LoadingActivity.rawValue

        password.accessibilityIdentifier =
            AccessibilityIndetifier.PasswordFiled.rawValue
    }
